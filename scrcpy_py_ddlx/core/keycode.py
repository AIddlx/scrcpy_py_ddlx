"""
Android KeyCode constants for scrcpy.

This module defines all Android keycode constants as defined in:
https://developer.android.com/reference/android/view/KeyEvent

Keycodes are used to inject key events into the Android device.
"""
...
class AndroidKeyCode(IntEnum):
    ...
    These constants correspond to the values defined in:
    ...
    ESCAPE = 111
    FORWARD_DEL = 112  # Delete key
    CTRL_LEFT = 113
    CTRL_RIGHT = 114
    CAPS_LOCK = 115
    SCROLL_LOCK = 116
    META_LEFT = 117  # Win key
    META_RIGHT = 118
    FUNCTION = 119
    SYSRQ = 120  # Print Screen
    BREAK = 121
    MOVE_HOME = 122
    MOVE_END = 123
    INSERT = 124
    ...
    # ========== More Media/System Keys ==========
    VOLUME_MUTE = 164  # Speaker mute
    INFO = 165
    CHANNEL_UP = 166
    CHANNEL_DOWN = 167
    ZOOM_IN = 168
...
# For shorter imports, you can use:
# from scrcpy_py_ddlx.core.keycode import AndroidKeyCode as KeyCode
KeyCode = AndroidKeyCode  # Type alias for convenience
